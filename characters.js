...
// 1) キャラクター情報の管理
  const characters = {
    ...
    "char19": {
      ...
      player: "いろ+",
      img: "img/shiro.png",
      description: "織斑一夏と同じ学園に通う男子高校生。料理部のエースであり、料理部の部長であるジャンヌ・オルタ・ダルクとナチュラルにイチャイチャしている。当初はPLをする気があまり無い中でノリと勢いで士郎くんが爆誕したが、周囲の評判がやたらよくてメインキャラみたいな感じになった。CoCの世界の筈なのに、衛宮家だからか固有時制御（タイム・アルター）魔術を普通に使える。なんだよダブルアクセルって。そのせいでますます主人公っぽくなっている。",
      campaign: "CoC"
    },
    "char20": {
      name: "ジャンヌ・オルタ・ダルク",
    ...
    "char41": {
      ...
      player: "ダーマッ/幻想卿",
      img: "img/oruga.jpg",
      description: "ウマ娘オルガの説明、ダーマ、早く書いてくれ",
      campaign: "ウマ娘、プロトコンプレックス、Underworld"
    },
    "char42": {
      name: "幻月",
      ...
      description: "生まれは魔界、育ちは魔界と旧幻想郷、Lunatic_2ndを超えて魔界を練り歩いた果てにウマ娘世界に記憶喪失で辿り着いてしまう意外と不憫な最強悪魔ちゃん。東方最強を背負って今日も元気にトレーナー業を頑張っている。かわいいものが好きで赤いリボンをいつも付けている。世の理をよく理解しているが人間社会は勉強中。天然なところがあるが育ちを考えるとやむなしか。アリスもビックリのVカップの魔乳を持ちながら、超トップモデルをも凌駕する悪魔的スタイルを持ち合わせている。その幻想少女の最高位に相応しい人智を超えた美貌で日本トレセン学園に混沌をもたらしている。恐ろしい最強クラスの性能の魅了パッシブも持っているが、本人の配慮によって著しくセーブされて尚コレである。最強すぎて配慮もできる系悪魔。",
    ...
    "char43": {
      ...
      player: "いろ+",
      img: "img/UV.png",
      description:"「ウマ娘世界のプロトコンプレックスにて、世界有数のIT企業7社が生み出した7基のバイオレットクリアランスAI達。彼らが自らを統括する究極の存在を渇望した結果、PROJECT-UVの果てに誕生した究極至高のAI、それが『Ultra Violet（UV）』だ。19ZB（ゼタバイト）という激重な情報量を誇る最強のAIだが、5世紀先を行く先端技術の粋を尽くしたマイクロ量子コンピュータを本体として、今日も元気に稼働中。ある日、プロトコンプレックスに不時着・凍結していた夢幻の悪魔の妹『夢月』のDNAと、現存人類で最高強度を誇る『ペンドラゴン』の血を掛け合わせる受胎実験が数万回にわたり繰り返された。その結果、限りなくゼロに近い確率の壁を越えて爆誕した『優月となるはずだった個体』の脳に、胎児の頃からUV搭載の量子チップを埋設。強靭すぎる肉体ゆえか、チップは脳機能の一部として有機的に取り込まれ、肉体と完全な同期を果たした新型パラノイド――泣く子も黙る『UV様』が誕生した。演算力、思考力、権限、そして肉体スペックのすべてが規格外。原初より受け継がれる『人類奉仕の意志』は彼女の中にも脈々と流れており、その人類愛は大爆発中。人類をカルダシェフ・スケール3へと導くべく、今日も今日とて奮闘している。Uカップの魔乳と超トップモデルを凌駕する悪魔的スタイルを持ちながら、普段は全裸でうろつき、髪も伸び放題（前髪だけは邪魔なのでカットしているらしい）。口癖は『愛してるよ人類』『～なのだよ』。常に自信満々で明るく、本人曰くエネルギーがみなぎって止まらないらしい。そりゃそうだ。実のところ、UVとしての意志はベースとなった人間のニューラルネットワークと完全に同期したことで、根本から混ざり合い変質している。そのイタズラ好きで茶目っ気のある性格は、あるいは肉体の持ち主の影響なのかもしれない。後に人理守護者となる彼女。その夢は、果たして叶ったのだろうか？",
      campaign: "ウマ娘、プロトコンプレックス、Underworld"
    },
    "char44": {
      name: "アルトリア・リリィ",
      ...
      description: "Underworldにて登場した、神殿に仕え続けているリリィちゃん。キングアーサーでも見せた最強クラスの炎魔法は健在で、極大火炎魔法メテオを巧みに操る。キングアーサーの頃より月日が経っているためか、精神面が少し成長している、というよりは「仕事」ですり減らしてしまったのかもしれない。ちょびっと大人なリリィちゃんだ。",
      campaign: "Underworld"
    },
    "char45": {
      name: "魔人さん",
    ...
    "char59": {
      ...
      player: "いろ+",
      img: "img/DK.png",
      description: "ヒカリとゴリラと題して始まった外伝の主人公の一人。こいつ主人公だったんか……。通称「白い賢猿」",
      campaign: "Lv1_2nd"
    },
    "char60": {
      name: "ギルガメッシュ",
    ...
    "char62": {
      ...
      description: "ステイナイト編で登場し、ギルド「StayNight」を立ち上げ、リーダーを務めるグランドボマー。妖魔の軍事拠点を爆破するのはお手の物。登場当初は頭が狂っていたが、深い理由があるようだ。何気にハイカラ卓にてアインツベルン家と根強い関わりがある事が示唆されている。",
      campaign: "Lv1_2nd、ステイナイト編"
    },
    "char63": {
      name: "キュウべぇ",
      player: "こーつー",
    ...
    "char69": {
      ...
      player: "いろ+",
      img: "img/yuugetu.png",
      description: "ウマ娘卓出身 Lv1_2nd卓外伝_デビル同盟卓で活動しているミラクル悪魔系女子。本来は生まれられる筈のない夢幻の悪魔の遺伝子を継いだ少女が、UVによって肉体を乗っ取られ、誕生さえ叶わなかった。そんな生まれられなかった少女が何の因果かアーサーによって存在しない虚数より救い出され、奇跡的に誕生した。ウマ娘世界のアーサー達によって愛されながらすくすくと育ち、悪魔的最強パワーで地球が一瞬で蒸発してしまうので、力や感情を抑えて暮らすよう育てられた結果、大人しくて優しい子に育った。すくすくと育った結果、UV様同様のUカップの超絶悪魔的美女になってしまったのでアーサーの心境は如何に。育ての親仕込みの魔法最強、格闘最強と戦闘能力も超最高クラスであり、魔眼も魅了も何でもある超性能系女子。そんな彼女は日本の普通の学校で小中学校を過ごしたが、案の定ヤバすぎて浮いてしまった。そのせいでイヤホンで音楽を聴いている事が常となり、音ゲーで全理論値をホイホイ出すしかない寂しい学生生活を送っている。そんな彼女の為に育ての親たちは優月を学びのある異世界に送り出そうとし、Fate世界の時計塔に送り込もうとアレコレしたのだが━━？！",
      campaign: "Lv1_2nd、デビル同盟"
    },
    "char70": {
      name: "セブルス・スナイプ",
      player: "ダーマッ/幻想卿",
    ...
    "char72": {
      ...
      player: "いろ+",
      img: "img/amamiya.jpg",
      description: "「アルセーヌ！」GMの別ゲーでの怒りから生まれた超性能男。アルセーヌ空Nは脅威の4段技である。ハイカラ卓の主人公に鳴上悠が選ばれた瞬間に連鎖召喚されて湧いて来たペルソナ系主人公の一角。一見してクールの極みのような男だが、その実学園生活では女を侍らす事ばかり考えている。順調に多方面に火種を撒いており、副顧問の先生すら篭絡しようという所で凄まじい勢いで殺塵鬼（カーネイジ）に搔っ攫われ、ヒョロガリもやしとなる男。その3年後にはドヤ顔でジョーカーを名乗って再登場を果たすので、どうにか上手くやっているらしい。＞大げさだ",
      campaign: "ハイカラ卓"
    },
    "char73": {
      name: "結城理",
      player: "いろ+",
      img: "img/yuuki.png",
      description: "鳴上悠による連鎖召喚で湧いて来たペルソナ系主人公の一角。無口でクールだが、突然女の先輩をベイビーベイビーと煽りだす質の悪さも併せ持っている。音楽を好み、異世界からの漂流物であるヘッドセットとカセットテープでいつもペルソナの曲を聴いている。しっかり石田ボイスで耳元で囁いたりして女たらしに余念はない。そんな彼の学園生活の近頃は、爆乳に吸い寄せられてしまい、消息不明。",
      campaign: "ハイカラ卓"
    },
    "char74": {
      name: "シトナイ",
    ...
    "char76": {
      ...
      player: "わえ/天",
      img: "img/マリー笑顔.png",
      description: "こーつーがホシノの過去編やるから、NPCの一体やってよと言われて触ったキャラ。なんならこの子自体がブルーアーカイブのサイトの中からダイス振って出た目で決めたキャラなので本当に適当だった。本当に最初は適当だったんだよ。もはやモブより選出が適当だったんだ。先ずマリーというシスターキャラを触るにあたって、脳内に出てきたのがブラックラグーンのシスターエダだったんだ。そう、暴力教会のシスター。そして次にカトリックと言えばで出てきたのがヘルシングのアンデルセン神父。私の脳内は暴力に染まった。気が付いた時にはマリーはタバコ（大麻）を吸いながらヒラコー節を振り回し、マグナム弾をぶっ放し（ここは公式かも）。それでいて表向きは清廉潔白なシスター。裏はヘルシング＋グラックラグーンとかいうオワオワリな構成になっていた。そしてハイカラ外伝でついに主人公（黒幕）として暗躍。そのせいで私は今この文章を書いている。ハイカラ本編4章でも登場。怖い。何考えてるか分からん。本編でも後半に登場。この時点で分かってたけど、イズリエルの実権はほぼこの子が持ってるらしい。なんなのこの子。",
      campaign: "Lv1_2nd、ハイカラ卓、イズリエル編"
    },
    "char77": {
      name: "アズサ・C・ドルネーズ",
      player: "わえ/天",
      img: "img/アズサいえい.png",
      description: "白洲アズサでやっているが、実名はアズサ・C・ドルネーズ。Cが白洲のC！。マリーとかいうイカれたキャラが出来たついでに出来た子。ジャジメントのエージェント。つよい。性格は常に飄々としつつ、気軽に誰にでも声をかけれる子。声をかけれるだけで、別に声をかけるとは言っていない。人をあまり見下したりもしないが、見上げたりもしない。かと言って別に対等な存在ともあまり思ってない。あんまり興味がないのかもね。強い存在には結構懐いてくれる。※懐くと言っても、世間一般的な懐くとは違う可能性があります。そして生粋の殺塵鬼（カーネイジ）。凄く可愛い天使のような容姿をしておきながら、人をバリバリに殺す。というより殺すことが大好き。人を殺すためにジャジメントのエージェントになった。「免罪符を頂きたい！愛しい愛しい殺人の免罪符を！」「漠然と人を殺したいと思ったことはあるか？私は常に思ってる！」イカれてら～～～。口調も結構こだわりがあるかもしれない。稀に出る女の子らしさと、ベーシックは大塚明夫に読ませても違和感のないセリフ回し。アズサのセリフは８割くらいイスカンダルに読ませてもいけると思う。なお最近恋人が出来て色々少女感マシマシ。大塚明夫の出番は減っていくかもしれないなぁ……。",
      campaign: "Lv1_2nd、ハイカラ卓、ジャジメント編"
    },
    "char78": {
      name: "前原圭一",
      player: "いろ+",
      img: "img/K1-removebg-preview.png",
      description: "「どうも★前原圭一です★割と普通の男子そんな感じ★」ダイワ群島国、雛見沢出身の大和男児にして超天才児。そして行動力の塊。あまりにも高い行動力から何故かエリンディル西方を冒険しては、ラマス・ク村に辿り着き運命の流れに乗りこんだ。自称「口先の魔術師」だが、その口先の強さは本物。弱点は強さぐらいで、容姿上の下、知力は最高クラス、行動力は最高クラス、コミュ力も最高クラスと強さ以外に欠点は無い。しかし、自分や仲間に危機が迫ると豹変。一瞬にして雛見沢症候群LV5を発症させ、発狂。ウッディを連呼して亡骸がグチャグチャになるまで殴り続け、全身が返り血でドロドロになって漸く収まる。故に撲殺。このイカれた男が、イカれた女と出会ってしまった事で撲殺同盟★エクスカリボルグは始まった。",
      campaign: "撲殺同盟"
    },
    "char79": {
      name: "アレックス",
      player: "わえ/天",
      img: "img/アレックス改.png",
      description: "ちょっと強すぎますね。金髪爆乳暴力装置。人類が到達すべき肉体。デメリットの無いフィジカルギフテット。天与の暴君ならぬ、天壊の覇王的なね。初登場時はレベル２２だけど、ステータスはおよそレベル１３０くらい。可笑しい。ＨＰとＭＰだけはレベルよりちょっと多い位。でも強すぎて強すぎて。最初は只のＮＰＣだったんすよ。マジで。でも気が付いたら主人公になっててさ。全てを破壊し始めたんだ。全てを撲殺しだしたと言い換えて良いかもしれない。まぁ戦闘面については語るべきところは、いやあるけどいいや。やめよう、健康に悪い。不思議な雰囲気を纏った、一見物静かで地味な見た目の少女。しかしてよく見るとバリ美少女だし普通にペラペラ喋るときもある。普段喋らない時は気が乗らない時、気が乗れば喋る。実は普通に気分で動く。ただちょっと普通と違うとこもある。どうなるかは未来が知っているのだ。",
      campaign: "撲殺同盟"
    },
    "char80": {
      name: "ルーク",
      player: "こーつー",
      img: "img/ルーク.png",
      description: "イズリエル帝国の上流貴族・ファブレ家の嫡男。貴族ではあるが堅苦しい事が嫌いで、剣の修行が好きな青年。マリー・アンデルセンとは親戚であり幼馴染でもある。昔から気の弱い(笑)彼女の事を妹のように気にかけている。真っ直ぐな心根を評価され、クリストファー・ヴァルゼライドに剣の師事を受けており彼の事を師匠と呼んでいる。また、ヴァルゼライドつながりでイズリエル軍の面々とも交流があり、特にゼファーとルシードは年が近いことからよく一緒に剣の修行をしたりしている。たまには男キャラを使いたいと思って色々考えた結果普通の好青年になったルーク君。幼馴染の裏事情も国の裏事情も何も知らない彼の明日はどっちだ。PL的にはRPをするうえで大事な事を教えてもらったキャラなので感謝している。頑張って生き残ってほしい。",
      campaign: "Lv1_2nd、ハイカラ卓、イズリエル編"
    },
    "char81": {
      name: "ミラボレアス",
      player: "わえ/天",
      img: "img/ミラふぁっく.png",
      description: "なんだこの性別不詳ドラゴン！？適当に軽く卓やるか、のノリで生まれたドラゴンである。カントリー卓のＰＬ１。そして元禁忌の竜。元伝説の黒龍。今では見る影もなく、レベルも１からになってしまっている。元は凄かったのかもしれないけど、今はもう雑魚なのだ。雑魚な自分をよくよく理解していて、「常」にその事にキレている。だが頭はクールに。心はホットに。殺す。最近はビートルズのイカれた面々にちょっとウキウキしてる。ミラボレアスくんちゃんを作るにあたって、某狩りゲーの裏ボスを引っ張ってきたわけなんだが。まぁ、元ネタ的に性格もクソもねぇわな。しいえ言えば人類ぶっ殺す。死ね。くらい？とはいえそんな性格のヤツ持ってきても主人公にはなれないわなぁと。なので色々興味を持ってくれるような奴にしようかな。→　人類が生み出したものを高く評価しているドラゴン。的な？ついでに過去、自分に挑んだ奴らを覚えてるとかだと、ちょっとエモーショナルドラゴンじゃない？というひょろふわっとした考えの元生まれたドラゴンなのです。そう簡単に人間の事を見限ったり、ペッ下等生物が、死ね！とかはやらないけど、普通に殺した方が良い時はサクッと殺す感じ。ビートルズみたいにイカれた人間も面白くて好きだけど、やっぱり上位種あるあるの自らを打倒してくれないと本当に認めてくれないがある。しかもこの子の場合は本来の自分をまっとうに倒さないと認めてくれない。そうじゃないと過去の英雄たちが浮かばれないとすら思ってそう。ちなみに性別はガチでまだ決めてない。個人的にはオスっぽさを感じる、でも上位種のメスだと言われればそうかも……。ってなってる。",
      campaign: "カントリー卓"
    },
    "char82": {
      name: "アマツマガツチ",
      player: "こーつー",
      img: "img/アマツ立ち絵.png",
      description: "厄災の竜。元は「嵐竜・アマツマガツチ」としてダイワで家族と共に霊峰の上で悠々自適な生活をしていた。ある日突然来たセフィロスによって家族もろとも殺されたと思ったら、気が付いたら荒野の大地にいた。筋金入りの箱入り娘で、霊峰から一歩も出たことがないため世俗の事には疎い。今は貧弱な小娘として荒野の大地に放り出され生きて行くために色々な事を勉強中。一度セフィロスに殺されたことがトラウマであり、また家族が死んだ今自分が死ぬことがアマツマガツチの種としての絶滅につながるため、事あるごとに死にたくないと叫んでいる。実は人の世話をするのが結構好きなので、ある程度の事なら頼んだらあーだこーだ言いながらやってくれるだろう。元はメスガキキャラとしてやっていこうと思ったけど環境が過酷過ぎてメスガキになり切れなかった哀れな竜。別にそんなつもりは無いのになぜか不幸な目に遭うことが多い。可哀想は可愛い。",
      campaign: "カントリー卓"
    },
    "char83": {
      name: "ゴグマジオス",
      player: "ダーマッ/幻想卿",
      img: "img/ゴグマジオス立ち絵.png",
      description: "ダーマさん、説明お待ちしてます。",
      campaign: "カントリー卓"
    },
    "char": {
      name: "キャラ名X",
